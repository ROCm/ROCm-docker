...
## ROCm for docker
This repository contains a framework for building the software layers defined in ROCm into portable docker images.  The following are docker dependencies, which should be installed on the target machine.
